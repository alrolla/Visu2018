...
<body>
    ...
    <div id="ventana" class="ventana" style="position:absolute;top:50px;left:100px;height:460px;width:680px;z-index:39999;background-color: #cfc9c9;display :none;overflow:hidden;">
      ...
      <div id="plot" class="ventana2" style="position:relative;left:-2px;top:4px;height:460px;width:680px;z-index:39999;background-color: #ffffff;overflow:hidden;"></div>
    </div>
    ...
    <div id="info" class="metaEst" style="position:absolute;top:50px;left:100px;height:220px;width:220px;background-color:#dddddd;z-index:19999;display:none">
     <table style="margin:5px;font-size:12px">
        <tr>
            <td width="25px" align="right" style="padding: 1px;text-align:right;background-color:orange;border-radius:5px; ">idOMM:</td>
            <td width="175px" id="t_id" style="text-align:center;background-color:white;border-radius:10px;" ></td>
         </tr>
        <tr>

            <td width="25px" align="right" style="padding: 1px;text-align:right;background-color:orange;border-radius:5px; ">Nombre:</td>
            <td width="175px" id="t_nom" style="text-align:center;background-color:white;border-radius:10px;" ></td> <!-- Nombre de la estacion -->
         </tr>
        <tr>
            <td width="25px" align="right"  style="padding: 1px;text-align:right;background-color:orange;border-radius:5px; ">Latitud:</td>
            <td width="175px" id="t_lat" style="text-align:center;background-color:white;border-radius:10px;"></td>
         </tr>
        <tr>
            <td width="25px" align="right"  style="padding: 1px;text-align:right;background-color:orange;border-radius:5px; ">Longitud:</td>
            <td width="175px" id="t_lon" style="text-align:center;background-color:white;border-radius:10px;"></td>
         </tr>
        <tr>
            <td width="25px" align="right"  style="padding: 1px;text-align:right;background-color:orange;border-radius:5px; ">Altura:</td>
            <td width="175px" id="t_alt" style="text-align:center;background-color:white;border-radius:10px;"></td>
         </tr>
        <tr >
         ...
         <tr>
            <td width="100%" align="center" colspan=2>
              <img  src="img/tmin.png" width="32" onclick="load_home('Tmin')" title="T. Minima"/>
              <img  src="img/tmed.png" width="30" onclick="load_home('Tmed')" title="T. Media"/>
              <img  src="img/tmax.png" width="30" onclick="load_home('Tmax')" title="T. Maxima"/>
            </td>

         </tr>
         <tr>
            <td width="100%" align="center" colspan=2>
              Min &nbsp&nbsp Med &nbsp&nbsp Max
            </td>
      ...
      //dibujando un circulo verde con borde negro
        ...
        var displayFeatureInfo = function(pixel) {
          ...
          if (feature) {
            ...
            // Mostramos la caja en el borde superior derecho
            $('#info').show();
          }
        ...
        map.on('click', function(evt) {
          displayFeatureInfo(evt.pixel);  // Mostramos el icono en amarillo y la info en
                                          // el borde superior derecho

        });
        function load_home(variable){
        	plot=document.getElementById("plot");
        	if(variable == 'Prcp'){
        		plot.innerHTML='<object type="text/html" data="php/st_prex.php?nest='+idOMM+'&var='+variable+'"  width="680px" height="450px"></object>';
        	}else{
        		plot.innerHTML='<object type="text/html" data="php/st_temp.php?nest='+idOMM+'&var='+variable+'"  width="680px" height="450px"></object>';
        	}
        	$('#ventana').show();
        }
        ...
        function hide(obj) {
            ...
            var ventana = document.getElementById(obj);
