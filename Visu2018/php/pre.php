<?php
    ...
    $sqlDATA="SELECT Fecha,Prcp from SMN_DATA_ARG where idOMM='".$Estacion ."' order by Fecha desc limit 366";
    ...
    $sqlCLIM="SELECT MM,DD,Prcp from SMN_CLIM_PRE_ARG where idOMM='".$Estacion ."' and TCLim=1980 order by MM asc, DD asc";
     //echo $sqlCLIM."\n";;
