<?php
    ...
    $sqlDATA="SELECT Fecha,Tmax,Tmin,Tmed from SMN_INTA_DATA_ARG where idOMM='".$Estacion ."' order by Fecha desc limit 366";
    ...
    $sqlCLIM="SELECT MM,DD,Tmax,Tmin,Tmed from SMN_INTA_CLIM_ARG where idOMM='".$Estacion ."' and TCLim=1980 order by MM asc, DD asc";
